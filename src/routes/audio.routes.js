...
audioRoutes.post("/library/:id", passport.authenticate("jwt", { session: false }), postLibrary);
audioRoutes.delete("/library/:id", passport.authenticate("jwt", { session: false }), deleteLibrary);
